...
import { MdAC } from "react-icons/md";
...
const CamperFeatures = ({ camper }) => {
  const getFeaturesList = () => {
    ...
    if (camper.AC) features.push({ icon: <MdAC />, label: "AC" });
    if (camper.kitchen)
      features.push({ icon: <FaKitchenSet />, label: "Kitchen" });
    if (camper.beds)
    ...
    if (camper.radio) features.push({ icon: <FaRadio />, label: "Radio" });
